...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera1', 'description': 'camera unique name'},
                           ...
                           {'name': 'depth_module.color_profile',   'default': '640,480,15', 'description': 'Depth module color stream profile for d405'},
...
def launch_setup(context, params, param_name_suffix=''):
    ...
    # )
    lifecycle_param_file = "/opt/ros/humble/share/realsense2_camera/config/global_settings.yaml"
